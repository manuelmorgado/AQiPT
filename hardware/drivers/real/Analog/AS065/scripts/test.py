...
# dds_rf = AS065(ADDRESS='130.79.148.73',
#                            PORT=80, ID='0x0', data=None);

import os,sys

os.chdir('/home/mmorgado/Desktop/AQiPT_vLaptop/')
sys.path.append("/home/mmorgado/Desktop/AQiPT_vLaptop/")
...
QM = drivers._analog_dev.opxqm(ADDRESS=ip_address) #op.opxqm(ADDRESS=ip_address)
QM.configure(config)
QM.generate_program()
QM.init_manager()
QM.connect()
...
# dds_rf = drivers._analog_dev.AS065(ADDRESS='130.79.148.73', PORT=80, ID='0x01', data=None)
# # dds_rf.flash();
# dds_rf.add_singleFrequency(3000000);
# dds_rf.sendRequest();



dds_767 = drivers._analog_dev.AS065(ADDRESS='130.79.148.72', PORT=80, ID='0x02', data=None)
# dds_767.flash();
