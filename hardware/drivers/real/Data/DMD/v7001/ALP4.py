...
ALP_PROJ_STEP =			2329	#	ALoperation should run in ALP_MASTER mode,
...
class ALP4():
    ...
    def SetTiming(self,  SequenceId = None, illuminationTime = None, pictureTime = None, synchDelay = None, synchPulseWidth = None, triggerInDelay = None):
        '''
